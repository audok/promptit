...
const koMessages = {
  ...
  'options.list.backupShareButton': '백업/공유',
  ...
  'options.backupShare.close': '백업/공유 닫기',
  'options.backupShare.dataGroupTitle': 'promptit 데이터 백업 & 복원',
  'options.backupShare.backupButton': '백업',
  'options.backupShare.restoreButton': '복원',
  'options.backupShare.promptGroupTitle': '프롬프트 공유 & 가져오기',
  'options.backupShare.shareButton': '프롬프트 전체 공유',
  'options.backupShare.importButton': '프롬프트 가져오기',
  'options.backupShare.shareDisabledEmpty': '저장된 프롬프트가 없습니다.',
  'options.backupShare.restorePreviewTitle': '복원할 백업 확인',
  ...
  'options.backupShare.confirmRestore': '복원',
  'options.backupShare.restoring': '복원 중...',
  'options.toast.backupExported': '백업 파일을 다운로드했습니다.',
  'options.toast.backupExportFailed': '백업 파일을 만들지 못했습니다.',
  'options.toast.promptsShared': '프롬프트 공유 파일을 다운로드했습니다.',
  'options.toast.promptsShareFailed': '프롬프트 공유 파일을 만들지 못했습니다.',
...
const enMessages: Record<I18nKey, string> = {
  ...
  'options.list.backupShareButton': 'Backup/share',
  ...
  'options.backupShare.close': 'Close backup/share',
  'options.backupShare.dataGroupTitle': 'promptit data backup & restore',
  'options.backupShare.backupButton': 'Back up',
  'options.backupShare.restoreButton': 'Restore',
  'options.backupShare.promptGroupTitle': 'Prompt share & import',
  'options.backupShare.shareButton': 'Share all prompts',
  'options.backupShare.importButton': 'Import prompts',
  'options.backupShare.shareDisabledEmpty': 'There are no saved prompts.',
  'options.backupShare.restorePreviewTitle': 'Confirm backup restore',
  ...
  'options.backupShare.confirmRestore': 'Restore',
  'options.backupShare.restoring': 'Restoring...',
  'options.toast.backupExported': 'Downloaded the backup file.',
  'options.toast.backupExportFailed': 'Could not create a backup file.',
  'options.toast.promptsShared': 'Downloaded the prompt share file.',
